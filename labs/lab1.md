...
1. [Инициализация рабочего окружения](#1)
2. [Страницы мануалов по командам](#2)
   - [Команда `man`](#21)
   - [Команда `man -k`](#22)
   - [Номера справочных разделов](#23)
3. [Работа с директориями](#3)
   - [Команда `pwd`](#31)
   - [Команда `cd`](#32)
   - [Абсолютные и относительные пути](#33)
   - [Завершение путей](#34)
   - [Утилита `ls`](#35)
   - [Утилита `mkdir`](#36)
   - [Утилита `rmdir`](#37)
4. [Дерево директорий Linux](#4)
   - [Стандарт иерархии файловой системы](#41)
   - [Страница руководства `man hier`](#42)

# Инициализация рабочего окружения <a name="1"></a>
...
## Страницы руководств `man` <a name="2"></a>
...
# Работа с директориями <a name="3"></a>

## Команда `pwd` <a name="31"></a>
...
## Абсолютные и относительные пути <a name="33"></a>
...
# Дерево директорий Linux <a name="4"></a>
...
## Стандарт иерархии файловой системы <a name="41"></a>
...
## Страница руководства `man hier` <a name="42"></a>
