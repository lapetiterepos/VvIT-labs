...
1. [Инициализация рабочего окружения](#init)
2. [Страницы мануалов по командам](#man)
   - [Команда `man`](#man_cmd)
   - [Команда `man -k`](#man_k)
   - [Номера справочных разделов](#man_num)
3. [Работа с директориями](#dir)
   - [Команда `pwd`](#dir_pwd)
   - [Команда `cd`](#dir_cd)
